...
module.exports = {
    ...
    URL_1NAME: process.env.URL_1NAME === undefined ? '🦄INSTAGRAM' : process.env.URL_1NAME,
    URL_1LINK: process.env.URL_1LINK === undefined ? 'https://www.instagram.com/__.sanuwa.__/' : process.env.URL_1LINK,
    ...
    STIC_WM:process.env.STIC_WM === undefined ? '░🥽░α░q░υ░α░🥽░' : process.env.STIC_WM,
    OWN_NAME:process.env.OWN_NAME === undefined ? '' : process.env.OWN_NAME,
    OWN_NUMBER:process.env.OWN_NUMBER === undefined ? '' : process.env.OWN_NUMBER,
    BRANCH: 'main',
    HEROKU: {
